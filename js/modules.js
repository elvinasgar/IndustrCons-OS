...
function openAccessForm() {
  ...
  document.getElementById('accessForm').onsubmit = (e) => {
    ...
    DB.set('access_log', rows); closeModal(); showToast('Qeyd əlavə olundu'); renderView('access-control');
  };
}
...
function openRfiForm() {
  ...
  document.getElementById('rfiForm').onsubmit = (e) => {
    ...
    DB.set('rfis', rows); closeModal(); showToast('RFI göndərildi'); renderView('rfi');
  };
}
...
function openInspectionForm() {
  ...
  document.getElementById('inspectionForm').onsubmit = (e) => {
    ...
    DB.set('inspections', rows); closeModal(); showToast('Yoxlama əlavə olundu'); renderView('inspection');
  };
}
...
function openFinanceForm() {
  ...
  document.getElementById('financeForm').onsubmit = (e) => {
    ...
    DB.set('finance_payments', rows); closeModal(); showToast('Əməliyyat əlavə olundu'); renderView('finance');
  };
}
